      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            NormalText(
                "Introdução à linguagem python, pontos positivos e negativos e suas aplicações."),
            TitleText("Resumo"),
            NormalText(
                "A linguagem de programação Python deu-se partida com o objetivo de desenvolver uma linguagem fácil, intuitiva e tão poderosa quanto as concorrentes. Estas características fizeram a linguagem se popularizar e se tornar amplamente utilizada, tanto por programadores quanto por engenheiros, matemáticos e pesquisadores em geral por - justamente - ser totalmente expressiva, sendo simples de traduzir o raciocínio em um algoritmo. Atualmente, uma das principais atuações do Python é no desenvolvimento da Inteligência Artificial (IA)."),
            TitleText("Orientações Pedagógicas"),
            NormalText(
                "Atente-se nos pontos fortes e fracos da utilização do python assim como suas principais aplicações, de modo a compreender sua atuação no mundo atual e, principalmente, a possibilidade de aplicar esta poderosa ferramenta na solução de seus problemas."),
